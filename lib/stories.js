...
function isStoryUnlocked(story) {
  ...
  // The first one is free. A new tab full of padlocks is a dead room, and a
  // child taps the newest icon first — 咏鹅 is also the 鹅，鹅，鹅 she already
  // sings in 课1, so it is the one poem she can meet before anything else.
  if (!story.unlockAfter) return true;
